...
import { Settings, ShoppingCart, UserPenIcon } from "lucide-react";
...
const ShopSidebar = () => {
  ...
  return (
    <motion.div
      className={` flex-shrink-0 overflow-hidden  transition-all duration-300 ease-in-out dark:text-gray-100 dark:bg-gray-800 h-[100vh] z-10`}
